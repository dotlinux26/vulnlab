...
> **Wordlists:** Besides `rockyou.txt`, install **SecLists** (the most complete wordlist collection). Quick on Kali: `sudo apt install -y seclists`, or download from GitHub: `https://github.com/danielmiessler/SecLists`.
