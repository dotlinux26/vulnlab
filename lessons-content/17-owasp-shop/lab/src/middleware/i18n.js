...
const dict = {
  vi: {
    ...
    forgot_title: 'Quên mật khẩu', forgot_send: 'Gửi mã OTP', forgot_link: 'Quên mật khẩu?',
    otp_sent_msg: 'Mã OTP đã được gửi qua email tới', new_password: 'Mật khẩu mới', reset_btn: 'Đổi mật khẩu',
  ...
  en: {
    ...
    forgot_title: 'Forgot password', forgot_send: 'Send OTP', forgot_link: 'Forgot password?',
    otp_sent_msg: 'An OTP has been emailed to', new_password: 'New password', reset_btn: 'Reset password',
